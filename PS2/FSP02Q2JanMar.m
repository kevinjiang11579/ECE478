% Q2 Jan Mar  Kevin Jiang
%Efficient frontier looks quite different, the means and  variances are much lower.
clear;
...
Kstonks = transpose(Kstonks(253:314,:));
Ksp500 = transpose(Ksp500(253:314,:));
